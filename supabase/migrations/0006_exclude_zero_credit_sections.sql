-- Exclude 0-credit sections (e.g. labs/discussions with no credit) from the
-- course page. Same as 0005 with an added `s.credits <> 0` filter.
...
as $$
  ...
  where s.course_code = p_course_code and s.term = p_term and s.credits <> 0
